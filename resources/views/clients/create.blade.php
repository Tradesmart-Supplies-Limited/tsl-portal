      ...
      <div class="row g-4">
        ...
        <div class="col-12">
          ...
          <div class="d-flex align-items-center gap-3">
            <img
              id="logoPreview"
              src="https://ui-avatars.com/api/?name=New+Client&background=696cff&color=fff"
              alt="Client logo"
              class="rounded"
        ...
        <div class="col-md-6">
          ...
          <select id="client_type" name="client_type" class="form-select @error('client_type') is-invalid @enderror" required>
            <option value="company" @selected(old('client_type', 'company') === 'company')>Company</option>
        ...
        <div class="col-md-4">
          ...
          <input type="text" id="source" name="source" class="form-control @error('source') is-invalid @enderror"
                 placeholder="e.g. Referral, Website" value="{{ old('source') }}">

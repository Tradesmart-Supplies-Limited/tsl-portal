    ...
    <form method="POST" action="{{ route('clients.update', $client) }}" enctype="multipart/form-data">
      ...
      <div class="row g-4">
        ...
        <div class="col-12">
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <small class="text-muted">PNG or JPG, up to 2MB. Leave blank to keep the current logo.</small>
        ...
        <div class="col-12">
          ...
          <small class="text-muted d-block mb-2">Mark one as primary — that's who we'll reach out to by default. Saving replaces the full contact list below.</small>

          <div id="contactRows">
            @forelse ($client->contacts as $i => $contact)
    ...
    rows.addEventListener('click', function (e) {
      if (e.target.closest('.remove-contact-row')) {
        ...
        if (document.querySelectorAll('.contact-row').length > 1) {
          ...
          row.querySelectorAll('input[type="text"], input[type="email"]').forEach(input => input.value = '');
        }
      }
    });
  })();
